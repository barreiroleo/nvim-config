--- Creds: https://gitlab.com/silvercircle74/nvim/-/blob/main/lua/local_utils/marks.lua
...
local sign_group_name = "user_marks_signs"
...
function Marks.setup()
    vim.api.nvim_create_autocmd({ 'BufEnter' }, {
        ...
        group = vim.api.nvim_create_augroup("UserAutocmd_Marks", { clear = true })
    })

-- Credits to: https://github.com/juniorsundar/nvim/blob/main/lua/config/lsp/hover.lua
...
vim.keymap.set("n", "<leader>K", toggle_auto_hover, { desc = "Toggle LSP auto hover", noremap = false, silent = true })
